...
const ReservationHistory = () => {
  ...
  // Chargement initial + changement du filtre statut
  useEffect(() => {
    fetchReservations();
  }, [statusFilter]);
  ...
  const fetchReservations = async () => {
    try {
      ...
      setError(
        "Impossible de charger les réservations. Vérifiez votre connexion ou vos droits."
      );
    } finally {
      setLoading(false);
    }
  ...
  // Filtrage côté frontend (recherche)
  useEffect(() => {
  ...
  return (
    <div className="reservation-history-page">
      <div className="container">
        ...
        {/* États */}
        {loading && (
          <p className="loading-message">Chargement des réservations...</p>
        )}
